export const Icons = {
  SendMail: ({ className }: { className?: string }) => (
    <svg
      className={className}
  ...
  DownloadCV: ({ className }: { className?: string }) => (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
      width="24"
  ...
  Astro: ({ className }: { className?: string }) => (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
      width="48"
  ...
  React: ({ className }: { className?: string }) => (
    ...
    >
      ...
      <path d="M11.5 12.866a1 1 0 1 0 1 -1.732a1 1 0 0 0 -1 1.732"></path>
    </svg>
  ),
  TypeScript: ({ className }: { className?: string }) => (
    ...
    >
      ...
      <path d="M21 19v-14a2 2 0 0 0 -2 -2h-14a2 2 0 0 0 -2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2 -2"></path>
    </svg>
  ),
  ...
  Pnpm: ({ className }: { className?: string }) => (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
      width="48"
    ...
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
      <path d="M3 17h4v4h-4l0 -4"></path>
      <path d="M10 17h4v4h-4l0 -4"></path>
      <path d="M17 17h4v4h-4l0 -4"></path>
      <path d="M17 10h4v4h-4l0 -4"></path>
      <path d="M17 3h4v4h-4l0 -4"></path>
      <path d="M10 10h4v4h-4l0 -4"></path>
      <path d="M10 3h4v4h-4l0 -4"></path>
      <path d="M3 3h4v4h-4l0 -4"></path>
    </svg>
  ),
  PostgreSQL: ({ className }: { className?: string }) => (
    ...
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
      <path d="M4 6a8 3 0 1 0 16 0a8 3 0 1 0 -16 0"></path>
  ...
  Docker: ({ className }: { className?: string }) => (
    ...
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
      <path d="M22 12.54c-1.804 -.345 -2.701 -1.08 -3.523 -2.94c-.487 .696 -1.102 1.568 -.92 2.4c.028 .238 -.32 1 -.557 1h-14c0 5.208 3.164 7 6.196 7c4.124 .022 7.828 -1.376 9.854 -5c1.146 -.101 2.296 -1.505 2.95 -2.46"></path>
      <path d="M5 10h3v3h-3l0 -3"></path>
      <path d="M8 10h3v3h-3l0 -3"></path>
      <path d="M11 10h3v3h-3l0 -3"></path>
      <path d="M8 7h3v3h-3l0 -3"></path>
      <path d="M11 7h3v3h-3l0 -3"></path>
      <path d="M11 4h3v3h-3l0 -3"></path>
  ...
  Experience: () => (
    <svg
      className="text-accent-cyan/70 group-hover:text-accent-cyan icon icon-tabler icons-tabler-outline transition-all duration-300 group-hover:drop-shadow-[0_0_8px_currentColor]"
      slot="icon"
      xmlns="http://www.w3.org/2000/svg"
      width="36"
      height="36"
  ...
  Education: () => (
    ...
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
      <path d="M19 4v16h-12a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2h12"></path>
      <path d="M19 16h-12a2 2 0 0 0 -2 2"></path>
      <path d="M9 8h6"></path>
    </svg>
  ),
  GithubOutline: ({ className }: { className?: string }) => (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
      width="24"
  ...
  GithubFilled: ({ className }: { className?: string }) => (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
      width="24"
  ...
  LinkedInFilled: ({ className }: { className?: string }) => (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
      width="24"
  ...
  TwitterOutline: ({ className }: { className?: string }) => (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
      width="24"
  ...
  TwitterFilled: ({ className }: { className?: string }) => (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
      width="24"
